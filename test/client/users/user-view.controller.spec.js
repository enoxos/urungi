const { DB_TYPE_OBJECT } = require('oracledb');
...
require('../../../public/js/users/users-view.controller.js');
...
describe('UsersViewController', function () {
    ...
    describe('activate', function () {
        ...
        it('should initialized current user properties', function () {
            ...
            vm = $controller('UsersViewController', { $routeParams: { userID: user._id } });
            $httpBackend.flush();
    ...
    describe('editUser', function () {
        ...
        it('should edit user', function () {
            ...
            vm = $controller('UsersViewController', { $uibModal: $uibModalMock, notify: notifyMock, $routeParams: { userID: user._id } });
            $httpBackend.flush();
        ...
        describe('deleteRole', function () {
            let admin, user, role, $uibModalMock, notifyMock;
